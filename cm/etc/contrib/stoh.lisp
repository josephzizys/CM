...
; (sal2html "/Users/hkt/404A/sal/sexpr.sal")
; (shell "open /Users/hkt/404A/sal/sexpr.html")


;<FORM ACTION="file:test.sal" METHOD=GET>
;<INPUT TYPE=submit VALUE="Download Source">
;</FORM>
...
(defun salhtmlfooter (out file)
  out file
  (format out "<hr/>~%<em>Generated by sal2html ~A~%</body>~%</html>~%"
	  (date-and-time)))
...
(defun stoh (file)
  (loop for f in (directory file) collect (sal2html f) into l
