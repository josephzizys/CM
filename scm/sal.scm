...
(begin
  ...
  (define SalSprout #x4100)
  (define SAL_COMMAND_END #x4200)
  (define SAL_CONSTITUENT_BEG #x4200)
  (define SalElse #x4300)
  (define SalEnd #x4411)
  (define SalReturn #x4500)
  (define SalThen #x4600)
  (define SalUnless #x4700)
  (define SalUntil #x4800)
  (define SalWait #x4900)
  (define SalWhen #x4a00)
  (define SalWhile #x4b00)
  (define SalWith #x4c00)
  (define SAL_CONSTITUENT_END #x4d00)
  (define SAL_STATEMENT_END #x4d00)
  (define SAL_CLAUSAL_BEG #x4d00)
  (define SalAbove #x4e00)
  (define SalBelow #x4f00)
  (define SalBy #x5000)
  (define SalDownto #x5100)
  (define SalFinally #x5200)
  (define SalFor #x5300)
  (define SalFrom #x5400)
  (define SalIn #x5500)
  (define SalOver #x5600)
  (define SalRepeat #x5700)
  (define SalTo #x5800)
  (define SAL_CLAUSAL_END #x5900)
  (define SAL_LITERAL_END #x5900)
  (define SAL_DEFINE_BEG #x5900)
  (define SalFunction #x5a00)
  (define SalProcess #x5b00)
  (define SalVariable #x5c00)
  (define SAL_DEFINE_END #x5d00)
  (define SAL_IDENTIFIER_BEG #x5d00)
  (define SalIdentifier #x5e00)
  (define SalSlotRef #x5f00)
  (define SAL_IDENTIFIER_END #x6000)
  (define SAL_TOKEN_END #x6000)
  (define SAL_RULE_BEG #x6000)
  (define SalNumberRule #x6100)
  (define SalBoolRule #x6200)
  (define SalAtomRule #x6300)
  (define SalListRule #x6400)
  (define SalEltRule #x6500)
  (define SalArefRule #x6600)
  (define SalIfExprRule #x6700)
  (define SalUnquoteRule #x6800)
  (define SalFuncallRule #x6900)
  (define SalFunargsRule #x6a00)
  (define SalPargsRule #x6b00)
  (define SalKargsRule #x6c00)
  (define SalOpRule #x6d00)
  (define SalMexprRule #x6e00)
  (define SalTermRule #x6f00)
  (define SalSexprRule #x7000)
  (define SalBindingsRule #x7100)
  (define SalBindRule #x7200)
  (define SalAssignmentRule #x7300)
  (define SalAssignRule #x7400)
  (define SalAssignerRule #x7500)
  (define SalSetRule #x7600)
  (define SalFunctionReturnRule #x7700)
  (define SalProcessWaitRule #x7800)
  (define SalBlockRule #x7900)
  (define SalConditionalRule #x7a00)
  (define SalLoopStatementRule #x7b00)
  (define SalRunStatementRule #x7c00)
  (define SalSteppingRule #x7d00)
  (define SalTerminationRule #x7e00)
  (define SalPrintStatementRule #x7f00)
  (define SalExecStatementRule #x8000)
  (define SalSendStatementRule #x8100)
  (define SalSoundFileStatementRule #x8200)
  (define SalSproutStatementRule #x8300)
  (define SalLoadStatementRule #x8400)
  (define SalChdirStatementRule #x8500)
  (define SalPlotStatementRule #x8600)
  (define SalDefineStatementRule #x8700)
  (define SalStatementRule #x8800)
  (define SalStatementSequenceRule #x8900)
  (define SalDeclarationRule #x8a00)
  (define SalVarDeclRule #x8b00)
  (define SalFunDeclRule #x8c00)
  (define SalProcDeclRule #x8d00)
  (define SalProcessBodyRule #x8e00)
  (define SAL_RULE_END #x8f00)
  (define SAL_TYPE_END #x8f00)
  )
