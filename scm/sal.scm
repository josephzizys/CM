...
(begin
  ...
  (define Sal2If #x4510)
  (define Sal2OutFile #x4610)
  (define SAL_COMMAND_END #x4700)
  (define SAL_CONSTITUENT_BEG #x4700)
  (define SalElse #x4800)
  (define SalEnd #x4911)
  ...
  (define SalSoundFileStatementRule #x8700)
  (define SalFomusFileStatementRule #x8800)
  (define SalSproutStatementRule #x8900)
  (define SalLoadStatementRule #x8a00)
  (define SalChdirStatementRule #x8b00)
  (define SalPlotStatementRule #x8c00)
  (define SalDefineStatementRule #x8d00)
  (define SalStatementRule #x8e00)
  (define SalStatementSequenceRule #x8f00)
  (define SalDeclarationRule #x9000)
  (define SalVarDeclRule #x9100)
  (define SalFunDeclRule #x9200)
  (define SalProcDeclRule #x9300)
  (define SalProcessBodyRule #x9400)
  (define Sal2BeginStatementRule #x9500)
  (define Sal2IfStatementRule #x9600)
  (define Sal2FunctionStatementRule #x9700)
  (define Sal2VariableStatementRule #x9800)
  (define Sal2WithStatementRule #x9900)
  (define Sal2LoopStatementRule #x9a00)
  (define Sal2RunStatementRule #x9b00)
  (define Sal2OutFileStatementRule #x9c00)
  (define Sal2StatementRule #x9d00)
  (define SAL_RULE_END #x9e00)
  (define SAL_TYPE_END #x9e00)
  )
