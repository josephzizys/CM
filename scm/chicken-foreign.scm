...
(define ffi_directory (foreign-lambda scheme-object "cm_directory" c-string bool))
(define ffi_pathname_to_key (foreign-lambda int "cm_pathname_to_key" c-string))
...
(define ffi_mp_set_instruments (foreign-lambda void "mp_set_instruments" scheme-object))
...
(define ffi_mp_set_midi_hook (foreign-lambda bool "mp_set_midi_hook" int scheme-object))
(define ffi_mp_is_midi_hook (foreign-lambda scheme-object "mp_is_midi_hook" int))
...
(define ffi_osc_open_p (foreign-lambda bool "osc_is_open"))
...
(define ffi_osc_set_hook (foreign-lambda scheme-object "osc_set_hook" c-string scheme-object))
(define ffi_osc_is_hook (foreign-lambda scheme-object "osc_is_hook" c-string))
