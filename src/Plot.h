...
class AxisView : public Component 
{
 ...
 public:
  ...
  /** setSpreadToFit sets the axis spread factor such that the axis
      maximally fits in the window without any scrollbars. size will
      be the view width for a horizonal axis and height for a vertical
      axis. **/
  ...
  public MidiPlaybackThread::MidiMessageSource
{
 ...
 public:
  ...
  bool isSelection();
  int numSelected();
  LayerPoint* getSelected(int index);
...
class PlotWindow : public DocumentWindow,
