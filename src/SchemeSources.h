...
namespace SchemeSources
{
    ...
    const int           chickenforeign_scmSize = 7964;
    ...
    const int           genffi_scmSize = 22303;
    ...
    const int           sal2_scmSize = 64371;

    extern const char*  sal2_text;
    ...
    const int           toolbox_scmSize = 28243;
