...
class SalSyntax : public Syntax
{
 public:
  ...
  enum SalTypes {
    ...
    SalSoundFile = 0x4010,
    SalSprout = 0x4100,
    SAL_COMMAND_END = 0x4200,
    SAL_CONSTITUENT_BEG = 0x4200,
    SalElse = 0x4300,
    SalEnd = 0x4411,
    SalReturn = 0x4500,
    SalThen = 0x4600,
    ...
    SalUnquoteRule = 0x6800,
    SalFuncallRule = 0x6900,
    SalFunargsRule = 0x6a00,
    SalPargsRule = 0x6b00,
    SalKargsRule = 0x6c00,
    SalOpRule = 0x6d00,
    SalMexprRule = 0x6e00,
    SalTermRule = 0x6f00,
    SalSexprRule = 0x7000,
    SalBindingsRule = 0x7100,
    SalBindRule = 0x7200,
    SalAssignmentRule = 0x7300,
    SalAssignRule = 0x7400,
    SalAssignerRule = 0x7500,
    SalSetRule = 0x7600,
    SalFunctionReturnRule = 0x7700,
    SalProcessWaitRule = 0x7800,
    SalBlockRule = 0x7900,
    SalConditionalRule = 0x7a00,
    SalLoopStatementRule = 0x7b00,
    SalRunStatementRule = 0x7c00,
    SalSteppingRule = 0x7d00,
    SalTerminationRule = 0x7e00,
    SalPrintStatementRule = 0x7f00,
    SalExecStatementRule = 0x8000,
    SalSendStatementRule = 0x8100,
    SalSoundFileStatementRule = 0x8200,
    SalSproutStatementRule = 0x8300,
    SalLoadStatementRule = 0x8400,
    SalChdirStatementRule = 0x8500,
    SalPlotStatementRule = 0x8600,
    SalDefineStatementRule = 0x8700,
    SalStatementRule = 0x8800,
    SalStatementSequenceRule = 0x8900,
    SalDeclarationRule = 0x8a00,
    SalVarDeclRule = 0x8b00,
    SalFunDeclRule = 0x8c00,
    SalProcDeclRule = 0x8d00,
    SalProcessBodyRule = 0x8e00,
    SAL_RULE_END = 0x8f00,
    SAL_TYPE_END = 0x8f00
  };
