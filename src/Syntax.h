...
class SalSyntax : public Syntax
{
 public:
  ...
  enum SalTypes
  {
    ...
    Sal2If = 0x4510,
    Sal2OutFile = 0x4610,
    SAL_COMMAND_END = 0x4700,
    SAL_CONSTITUENT_BEG = 0x4700,
    SalElse = 0x4800,
    SalEnd = 0x4911,
    SalReturn = 0x4a00,
    SalThen = 0x4b00,
    ...
    SalSoundFileStatementRule = 0x8700,
    SalFomusFileStatementRule = 0x8800,
    SalSproutStatementRule = 0x8900,
    SalLoadStatementRule = 0x8a00,
    SalChdirStatementRule = 0x8b00,
    SalPlotStatementRule = 0x8c00,
    SalDefineStatementRule = 0x8d00,
    SalStatementRule = 0x8e00,
    SalStatementSequenceRule = 0x8f00,
    SalDeclarationRule = 0x9000,
    SalVarDeclRule = 0x9100,
    SalFunDeclRule = 0x9200,
    SalProcDeclRule = 0x9300,
    SalProcessBodyRule = 0x9400,
    Sal2BeginStatementRule = 0x9500,
    Sal2IfStatementRule = 0x9600,
    Sal2FunctionStatementRule = 0x9700,
    Sal2VariableStatementRule = 0x9800,
    Sal2WithStatementRule = 0x9900,
    Sal2LoopStatementRule = 0x9a00,
    Sal2RunStatementRule = 0x9b00,
    Sal2OutFileStatementRule = 0x9c00,
    Sal2StatementRule = 0x9d00,
    SAL_RULE_END = 0x9e00,
    SAL_TYPE_END = 0x9e00
  };
