...
class SalSyntax : public Syntax
{
 public:
  ...
  enum SalTypes {
    ...
    SalWhile = 0x4c00,
    SalWith = 0x4d00,
    SAL_CONSTITUENT_END = 0x4e00,
    SAL_STATEMENT_END = 0x4e00,
    SAL_CLAUSAL_BEG = 0x4e00,
    SalAbove = 0x4f00,
    SalBelow = 0x5000,
    SalBy = 0x5100,
    SalDownto = 0x5200,
    ...
    SalRepeat = 0x5800,
    SalTo = 0x5900,
    SAL_CLAUSAL_END = 0x5a00,
    SAL_LITERAL_END = 0x5a00,
    SAL_DEFINE_BEG = 0x5a00,
    SalFunction = 0x5b00,
    SalProcess = 0x5c00,
    SalVariable = 0x5d00,
    SAL_DEFINE_END = 0x5e00,
    SAL_IDENTIFIER_BEG = 0x5e00,
    SalIdentifier = 0x5f00,
    SalSlotRef = 0x6000,
    SAL_IDENTIFIER_END = 0x6100,
    SAL_TOKEN_END = 0x6100,
    SAL_RULE_BEG = 0x6100,
    SalNumberRule = 0x6200,
    SalBoolRule = 0x6300,
    SalAtomRule = 0x6400,
    SalListRule = 0x6500,
    SalEltRule = 0x6600,
    SalArefRule = 0x6700,
    SalIfExprRule = 0x6800,
    SalUnquoteRule = 0x6900,
    ...
    SalSendStatementRule = 0x8200,
    SalSoundFileStatementRule = 0x8300,
    SalFomusFileStatementRule = 0x8400,
    SalSproutStatementRule = 0x8500,
    SalLoadStatementRule = 0x8600,
    SalChdirStatementRule = 0x8700,
    SalPlotStatementRule = 0x8800,
    SalDefineStatementRule = 0x8900,
    SalStatementRule = 0x8a00,
    SalStatementSequenceRule = 0x8b00,
    SalDeclarationRule = 0x8c00,
    SalVarDeclRule = 0x8d00,
    SalFunDeclRule = 0x8e00,
    SalProcDeclRule = 0x8f00,
    SalProcessBodyRule = 0x9000,
    SAL_RULE_END = 0x9100,
    SAL_TYPE_END = 0x9100
  };
