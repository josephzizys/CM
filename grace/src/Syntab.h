...
/* 
   ...
   a la emacs. scanning code should not need any JUCE classes except
   String and should assume that String is just a buffer of chars, ie
   as if it were "typedef char * String".
