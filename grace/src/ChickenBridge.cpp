...
if(!C_demand_2(1382)){
C_save(t1);
C_rereclaim2(1382*sizeof(C_word), 1);
t1=C_restore;}
a=C_alloc(3);
C_initialize_lf(lf,219);
...
lf[59]=C_static_lambda_info(C_heaptop,15,"(pickl args189)");
lf[60]=C_h_intern(&lf[60],4,"pick");
lf[61]=C_static_lambda_info(C_heaptop,16,"(pick . args190)");
lf[62]=C_h_intern(&lf[62],13,"print-message");
lf[63]=C_h_intern(&lf[63],17,"\003sysmake-c-string");
lf[64]=C_static_lambda_info(C_heaptop,23,"(print-message a224228)");
lf[65]=C_h_intern(&lf[65],11,"print-error");
lf[66]=C_static_lambda_info(C_heaptop,21,"(print-error a230234)");
lf[67]=C_h_intern(&lf[67],25,"current-time-milliseconds");
lf[68]=C_static_lambda_info(C_heaptop,27,"(current-time-milliseconds)");
lf[69]=C_h_intern(&lf[69],20,"current-time-seconds");
lf[70]=C_static_lambda_info(C_heaptop,22,"(current-time-seconds)");
lf[72]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[73]=C_h_intern(&lf[73],6,"\003sysgc");
lf[74]=C_static_lambda_info(C_heaptop,41,"(scheduler-set-time-milliseconds a260263)");
lf[76]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[77]=C_static_lambda_info(C_heaptop,42,"(scheduler-sprout a268271 a267272 a266273)");
lf[79]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[80]=C_static_lambda_info(C_heaptop,24,"(scheduler-stop a288291)");
lf[81]=C_h_intern(&lf[81],6,"sprout");
lf[82]=C_static_lambda_info(C_heaptop,11,"(nextstart)");
lf[83]=C_static_lambda_info(C_heaptop,8,"(nextid)");
lf[84]=C_static_lambda_info(C_heaptop,12,"(do316 p318)");
lf[85]=C_static_lambda_info(C_heaptop,24,"(body302 start308 id309)");
lf[86]=C_static_lambda_info(C_heaptop,24,"(def-id305 %start300324)");
lf[87]=C_static_lambda_info(C_heaptop,14,"(def-start304)");
lf[88]=C_static_lambda_info(C_heaptop,26,"(sprout proc298 . args299)");
lf[89]=C_h_intern(&lf[89],3,"now");
lf[90]=C_h_intern(&lf[90],11,"time-format");
lf[91]=C_flonum(C_heaptop,1.0);
lf[92]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[93]=C_flonum(C_heaptop,1.0);
lf[94]=C_h_intern(&lf[94],1,"m");
lf[95]=C_static_string(C_heaptop,17,"not a time-format");
lf[96]=C_h_intern(&lf[96],1,"s");
lf[97]=C_static_lambda_info(C_heaptop,22,"(time-format . arg330)");
lf[98]=C_h_intern(&lf[98],5,"pause");
lf[99]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[100]=C_static_lambda_info(C_heaptop,7,"(pause)");
lf[101]=C_h_intern(&lf[101],7,"paused\077");
lf[102]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[103]=C_static_lambda_info(C_heaptop,9,"(paused\077)");
lf[104]=C_h_intern(&lf[104],4,"cont");
lf[105]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[106]=C_static_lambda_info(C_heaptop,6,"(cont)");
lf[107]=C_h_intern(&lf[107],4,"stop");
lf[108]=C_static_string(C_heaptop,17,"Not an integer id");
lf[109]=C_static_lambda_info(C_heaptop,15,"(do344 tail346)");
lf[110]=C_static_lambda_info(C_heaptop,18,"(stop . procid343)");
lf[111]=C_h_intern(&lf[111],4,"hush");
lf[112]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[113]=C_static_lambda_info(C_heaptop,6,"(hush)");
lf[116]=C_h_intern(&lf[116],7,"sprintf");
lf[117]=C_static_lambda_info(C_heaptop,23,"(ferror str357 args358)");
lf[118]=C_h_intern(&lf[118],7,"mp:note");
lf[119]=C_static_lambda_info(C_heaptop,3,"\000\000\000");
lf[120]=C_static_lambda_info(C_heaptop,46,"(mp:note time395 dur396 key397 amp398 chan399)");
lf[121]=C_h_intern(&lf[121],5,"mp:on");
lf[122]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[123]=C_static_lambda_info(C_heaptop,37,"(mp:on time400 key401 vel402 chan403)");
lf[124]=C_h_intern(&lf[124],6,"mp:off");
lf[125]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[126]=C_static_lambda_info(C_heaptop,38,"(mp:off time404 key405 vel406 chan407)");
lf[127]=C_h_intern(&lf[127],7,"mp:prog");
lf[128]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[129]=C_static_lambda_info(C_heaptop,33,"(mp:prog time408 prog409 chan410)");
lf[130]=C_h_intern(&lf[130],7,"mp:ctrl");
lf[131]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[132]=C_static_lambda_info(C_heaptop,40,"(mp:ctrl time411 ctrl412 val413 chan414)");
lf[133]=C_h_intern(&lf[133],9,"mp:alloff");
lf[134]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[135]=C_static_lambda_info(C_heaptop,11,"(mp:alloff)");
lf[136]=C_h_intern(&lf[136],8,"mp:micro");
lf[137]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[138]=C_static_lambda_info(C_heaptop,18,"(mp:micro divs415)");
lf[139]=C_h_intern(&lf[139],9,"mp:inhook");
lf[140]=C_static_string(C_heaptop,33,"message function not implemented.");
lf[141]=C_static_lambda_info(C_heaptop,19,"(mp:inhook func416)");
lf[142]=C_h_intern(&lf[142],14,"return-to-host");
lf[143]=C_h_intern(&lf[143],4,"else");
lf[144]=C_h_intern(&lf[144],4,"cond");
lf[145]=C_h_intern(&lf[145],6,"lambda");
lf[146]=C_h_intern(&lf[146],7,"elapsed");
lf[147]=C_h_intern(&lf[147],1,"x");
lf[148]=C_h_intern(&lf[148],4,"set!");
lf[149]=C_h_intern(&lf[149],4,"wait");
lf[150]=C_h_intern(&lf[150],4,"let*");
lf[151]=C_h_intern(&lf[151],5,"quote");
lf[152]=C_h_intern(&lf[152],3,"exn");
lf[153]=C_h_intern(&lf[153],7,"message");
lf[154]=C_h_intern(&lf[154],27,"condition-property-accessor");
lf[155]=C_h_intern(&lf[155],6,"printf");
lf[156]=C_static_string(C_heaptop,47,">>> Aborting process at time ~S:~%    Error: ~S");
lf[157]=C_h_intern(&lf[157],22,"with-exception-handler");
lf[158]=C_h_intern(&lf[158],30,"call-with-current-continuation");
lf[159]=C_h_intern(&lf[159],10,"\003sysappend");
lf[160]=C_h_intern(&lf[160],6,"safety");
lf[161]=C_h_intern(&lf[161],4,"cdar");
lf[162]=C_static_string(C_heaptop,19,"unknown declaration");
lf[163]=C_h_intern(&lf[163],4,"caar");
lf[164]=C_static_string(C_heaptop,31,"declaration not list (decl val)");
lf[165]=C_static_lambda_info(C_heaptop,15,"(do442 decl444)");
lf[166]=C_h_intern(&lf[166],7,"declare");
lf[167]=C_h_intern(&lf[167],6,"gensym");
lf[168]=C_h_intern(&lf[168],6,"append");
lf[169]=C_h_intern(&lf[169],5,"\000null");
lf[170]=C_static_string(C_heaptop,41,"binding clause not list (var init [step])");
lf[171]=C_static_lambda_info(C_heaptop,15,"(do426 tail428)");
lf[172]=C_static_string(C_heaptop,36,"go stopping clause missing test form");
lf[173]=C_static_string(C_heaptop,29,"go stopping clause not a list");
lf[174]=C_static_string(C_heaptop,22,"go bindings not a list");
lf[175]=C_static_lambda_info(C_heaptop,42,"(a2339 bindings417 terminate418 . body419)");
lf[176]=C_h_intern(&lf[176],18,"\003sysregister-macro");
lf[177]=C_h_intern(&lf[177],2,"go");
lf[178]=C_h_intern(&lf[178],15,"hash-table-set!");
lf[179]=C_static_string(C_heaptop,9,"mp:inhook");
...
C_drop(2);
C_save(tmp);
lf[180]=C_h_list(2,C_pick(1),C_pick(0));
C_drop(2);
lf[181]=C_static_string(C_heaptop,8,"mp:micro");
...
C_drop(2);
C_save(tmp);
lf[182]=C_h_list(2,C_pick(1),C_pick(0));
C_drop(2);
lf[183]=C_static_string(C_heaptop,9,"mp:alloff");
tmp=C_intern(C_heaptop,9,"mp:alloff");
C_save(tmp);
tmp=C_SCHEME_END_OF_LIST;
lf[184]=C_h_pair(C_restore,tmp);
lf[185]=C_static_string(C_heaptop,7,"mp:ctrl");
...
C_drop(2);
C_save(tmp);
lf[186]=C_h_list(5,C_pick(4),C_pick(3),C_pick(2),C_pick(1),C_pick(0));
C_drop(5);
lf[187]=C_static_string(C_heaptop,7,"mp:prog");
...
C_drop(2);
C_save(tmp);
lf[188]=C_h_list(4,C_pick(3),C_pick(2),C_pick(1),C_pick(0));
C_drop(4);
lf[189]=C_static_string(C_heaptop,6,"mp:off");
...
C_drop(2);
C_save(tmp);
lf[190]=C_h_list(5,C_pick(4),C_pick(3),C_pick(2),C_pick(1),C_pick(0));
C_drop(5);
lf[191]=C_static_string(C_heaptop,5,"mp:on");
...
C_drop(2);
C_save(tmp);
lf[192]=C_h_list(5,C_pick(4),C_pick(3),C_pick(2),C_pick(1),C_pick(0));
C_drop(5);
lf[193]=C_static_string(C_heaptop,7,"mp:note");
...
C_drop(2);
C_save(tmp);
lf[194]=C_h_list(6,C_pick(5),C_pick(4),C_pick(3),C_pick(2),C_pick(1),C_pick(0));
C_drop(6);
lf[195]=C_static_lambda_info(C_heaptop,15,"(do386 tail388)");
lf[196]=C_static_string(C_heaptop,37,"~S found duplicate keyword \047~S\047 in ~S");
lf[197]=C_static_string(C_heaptop,33,"~S missing value for keyword \047~S\047");
lf[198]=C_static_string(C_heaptop,53,"~S found invalid keyword \047~S\047~%Available keywords: ~S");
lf[199]=C_h_intern(&lf[199],7,"\003sysmap");
lf[200]=C_h_intern(&lf[200],3,"car");
lf[201]=C_static_string(C_heaptop,32,"~S expected keyword but got \047~S\047");
lf[202]=C_h_intern(&lf[202],8,"keyword\077");
lf[203]=C_static_string(C_heaptop,35,"~S expected ~A arguments but got ~A");
lf[204]=C_static_lambda_info(C_heaptop,28,"(do369 key371 arg372 pos373)");
lf[205]=C_static_string(C_heaptop,24,"~S is an invalid message");
lf[206]=C_static_lambda_info(C_heaptop,7,"(a1797)");
lf[207]=C_h_intern(&lf[207],14,"hash-table-ref");
lf[208]=C_h_intern(&lf[208],14,"symbol->string");
lf[209]=C_static_lambda_info(C_heaptop,25,"(a2345 mess393 . data394)");
lf[210]=C_h_intern(&lf[210],4,"send");
lf[211]=C_h_intern(&lf[211],10,"*messages*");
lf[212]=C_h_intern(&lf[212],14,"string->symbol");
lf[213]=C_static_string(C_heaptop,51,"message function not string, symbol or list of both");
lf[214]=C_static_lambda_info(C_heaptop,23,"(a2351 func351 info352)");
lf[215]=C_h_intern(&lf[215],19,"define-send-message");
lf[216]=C_h_intern(&lf[216],15,"make-hash-table");
lf[217]=C_h_intern(&lf[217],6,"equal\077");
lf[218]=C_static_lambda_info(C_heaptop,10,"(toplevel)");
C_register_lf2(lf,219,create_ptable());
...
t22=C_mutate((C_word*)lf[57]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1066,a[2]=lf[59],tmp=(C_word)a,a+=3,tmp));
t23=C_mutate((C_word*)lf[60]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1089,a[2]=lf[61],tmp=(C_word)a,a+=3,tmp));
t24=C_mutate((C_word*)lf[62]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1095,a[2]=lf[64],tmp=(C_word)a,a+=3,tmp));
t25=C_mutate((C_word*)lf[65]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1109,a[2]=lf[66],tmp=(C_word)a,a+=3,tmp));
t26=C_mutate((C_word*)lf[67]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1152,a[2]=lf[68],tmp=(C_word)a,a+=3,tmp));
t27=C_mutate((C_word*)lf[69]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1155,a[2]=lf[70],tmp=(C_word)a,a+=3,tmp));
t28=C_mutate(&lf[71],(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1167,a[2]=lf[74],tmp=(C_word)a,a+=3,tmp));
t29=C_mutate(&lf[75],(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1176,a[2]=lf[77],tmp=(C_word)a,a+=3,tmp));
t30=C_mutate(&lf[78],(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1220,a[2]=lf[80],tmp=(C_word)a,a+=3,tmp));
t31=C_mutate((C_word*)lf[81]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1242,a[2]=lf[88],tmp=(C_word)a,a+=3,tmp));
t32=C_mutate((C_word*)lf[89]+1,*((C_word*)lf[67]+1));
t33=C_mutate((C_word*)lf[90]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1410,a[2]=lf[97],tmp=(C_word)a,a+=3,tmp));
t34=C_mutate((C_word*)lf[98]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1473,a[2]=lf[100],tmp=(C_word)a,a+=3,tmp));
t35=C_mutate((C_word*)lf[101]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1482,a[2]=lf[103],tmp=(C_word)a,a+=3,tmp));
t36=C_mutate((C_word*)lf[104]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1488,a[2]=lf[106],tmp=(C_word)a,a+=3,tmp));
t37=C_mutate((C_word*)lf[107]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1497,a[2]=lf[110],tmp=(C_word)a,a+=3,tmp));
t38=C_mutate((C_word*)lf[111]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1555,a[2]=lf[113],tmp=(C_word)a,a+=3,tmp));
...
t40=C_retrieve(lf[216]);
((C_proc3)C_retrieve_proc(t40))(3,t40,t39,*((C_word*)lf[217]+1));}
...
t8=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t8))(3,t8,t7,lf[213]);}}}}
...
t4=((C_word*)t0)[3];
((C_proc2)(void*)(*((C_word*)t4+1)))(2,t4,(C_word)C_a_i_list(&a,4,lf[178],lf[211],((C_word*)((C_word*)t0)[2])[1],t3));}
...
t2=C_mutate(&lf[115],(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1571,a[2]=lf[117],tmp=(C_word)a,a+=3,tmp));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1808,a[2]=((C_word*)t0)[2],tmp=(C_word)a,a+=3,tmp);
t4=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_2346,a[2]=lf[209],tmp=(C_word)a,a+=3,tmp);
C_trace("ChickenBridge.scm: 355  ##sys#register-macro");
t5=C_retrieve(lf[176]);
((C_proc4)C_retrieve_proc(t5))(4,t5,t3,lf[210],t4);}
...
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1798,a[2]=lf[206],tmp=(C_word)a,a+=3,tmp);
C_trace("ChickenBridge.scm: 287  hash-table-ref");
t4=*((C_word*)lf[207]+1);
((C_proc5)C_retrieve_proc(t4))(5,t4,t2,lf[114],t1,t3);}
...
f_1571(t2,lf[205],(C_word)C_a_i_list(&a,1,((C_word*)t0)[2]));}}
...
t5=C_set_block_item(t4,0,(*a=C_CLOSURE_TYPE|10,a[1]=(C_word)f_1651,a[2]=((C_word*)t0)[2],a[3]=((C_word*)t0)[3],a[4]=((C_word*)t0)[4],a[5]=t1,a[6]=((C_word*)t0)[8],a[7]=((C_word*)t0)[5],a[8]=t4,a[9]=((C_word*)t0)[6],a[10]=lf[204],tmp=(C_word)a,a+=11,tmp));
t6=((C_word*)t4)[1];
...
f_1571(t3,lf[203],(C_word)C_a_i_list(&a,3,((C_word*)t0)[5],((C_word*)t0)[2],t4));}
else{
t4=t3;
...
f_1571(((C_word*)t0)[6],lf[197],(C_word)C_a_i_list(&a,2,((C_word*)t0)[5],((C_word*)((C_word*)t0)[4])[1]));}
else{
...
C_trace("map");
t4=*((C_word*)lf[199]+1);
((C_proc4)(void*)(*((C_word*)t4+1)))(4,t4,t3,*((C_word*)lf[200]+1),((C_word*)t0)[2]);}}}
else{
C_trace("ChickenBridge.scm: 327  ferror");
f_1571(((C_word*)t0)[6],lf[201],(C_word)C_a_i_list(&a,2,((C_word*)t0)[5],((C_word*)((C_word*)t0)[4])[1]));}}
...
f_1571(((C_word*)t0)[4],lf[198],(C_word)C_a_i_list(&a,3,((C_word*)t0)[3],((C_word*)((C_word*)t0)[2])[1],t1));}
...
f_1571(t3,lf[196],(C_word)C_a_i_list(&a,3,((C_word*)t0)[4],((C_word*)((C_word*)t0)[3])[1],((C_word*)t0)[2]));}}
...
t4=C_set_block_item(t3,0,(*a=C_CLOSURE_TYPE|6,a[1]=(C_word)f_1611,a[2]=((C_word*)t0)[3],a[3]=t3,a[4]=((C_word*)t0)[4],a[5]=((C_word*)t0)[5],a[6]=lf[195],tmp=(C_word)a,a+=7,tmp));
t5=((C_word*)t3)[1];
...
t2=C_mutate((C_word*)lf[118]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1810,a[2]=lf[120],tmp=(C_word)a,a+=3,tmp));
t3=C_mutate((C_word*)lf[121]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1816,a[2]=lf[123],tmp=(C_word)a,a+=3,tmp));
t4=C_mutate((C_word*)lf[124]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1822,a[2]=lf[126],tmp=(C_word)a,a+=3,tmp));
t5=C_mutate((C_word*)lf[127]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1828,a[2]=lf[129],tmp=(C_word)a,a+=3,tmp));
t6=C_mutate((C_word*)lf[130]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1834,a[2]=lf[132],tmp=(C_word)a,a+=3,tmp));
t7=C_mutate((C_word*)lf[133]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1840,a[2]=lf[135],tmp=(C_word)a,a+=3,tmp));
t8=C_mutate((C_word*)lf[136]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1846,a[2]=lf[138],tmp=(C_word)a,a+=3,tmp));
t9=C_mutate((C_word*)lf[139]+1,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1852,a[2]=lf[141],tmp=(C_word)a,a+=3,tmp));
...
t11=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t11))(5,t11,t10,lf[114],lf[193],lf[194]);}
...
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[191],lf[192]);}
...
t3=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[189],lf[190]);}
...
t3=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[187],lf[188]);}
...
t3=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[185],lf[186]);}
...
t3=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[183],lf[184]);}
...
t3=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[181],lf[182]);}
...
t3=C_retrieve(lf[178]);
((C_proc5)C_retrieve_proc(t3))(5,t3,t2,lf[114],lf[179],lf[180]);}
...
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_2340,a[2]=lf[175],tmp=(C_word)a,a+=3,tmp);
...
t14=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t14))(4,t14,t13,lf[174],t2);}}
...
t3=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t3))(3,t3,t2,lf[172]);}
else{
t3=t2;
...
t3=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t3))(4,t3,t2,lf[173],((C_word*)t0)[8]);}}
...
t3=C_SCHEME_UNDEFINED;
t4=(*a=C_VECTOR_TYPE|1,a[1]=t3,tmp=(C_word)a,a+=2,tmp);
t5=C_set_block_item(t4,0,(*a=C_CLOSURE_TYPE|6,a[1]=(C_word)f_2175,a[2]=((C_word*)t0)[3],a[3]=((C_word*)t0)[5],a[4]=((C_word*)t0)[7],a[5]=t4,a[6]=lf[171],tmp=(C_word)a,a+=7,tmp));
t6=((C_word*)t4)[1];
...
t3=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t3))(4,t3,((C_word*)t0)[2],lf[170],t2);}}
...
t5=(C_word)C_eqp(((C_word*)t0)[3],lf[169]);
if(C_truep(t5)){
t6=t4;
f_2220(t6,C_SCHEME_END_OF_LIST);}
else{
t6=(C_word)C_a_i_list(&a,3,lf[148],((C_word*)t0)[2],((C_word*)t0)[3]);
t7=t4;
...
C_word *a;
t2=((C_word*)t0)[2];
f_2068(t2,(C_word)C_eqp(t1,lf[166]));}
...
t2=C_SCHEME_UNDEFINED;
t3=(*a=C_VECTOR_TYPE|1,a[1]=t2,tmp=(C_word)a,a+=2,tmp);
t4=C_set_block_item(t3,0,(*a=C_CLOSURE_TYPE|5,a[1]=(C_word)f_2077,a[2]=((C_word*)t0)[3],a[3]=t3,a[4]=((C_word*)t0)[4],a[5]=lf[165],tmp=(C_word)a,a+=6,tmp));
t5=((C_word*)t3)[1];
...
t3=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t3))(4,t3,((C_word*)t0)[4],lf[164],t2);}}
...
t4=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t4))(4,t4,((C_word*)t0)[4],lf[162],t3);}}
...
t3=(C_word)C_a_i_list(&a,3,lf[144],((C_word*)t0)[11],t2);
...
t8=(C_word)C_a_i_list(&a,2,lf[151],lf[152]);
t9=(C_word)C_a_i_list(&a,2,lf[151],lf[153]);
t10=(C_word)C_a_i_list(&a,3,lf[154],t8,t9);
t11=(C_word)C_a_i_list(&a,2,t10,((C_word*)t0)[2]);
t12=(C_word)C_a_i_list(&a,4,lf[155],lf[156],((C_word*)t0)[9],t11);
t13=(C_word)C_a_i_list(&a,2,((C_word*)t0)[3],C_fix(-2));
t14=(C_word)C_a_i_list(&a,4,lf[145],t7,t12,t13);
t15=(C_word)C_a_i_list(&a,3,lf[145],C_SCHEME_END_OF_LIST,((C_word*)((C_word*)t0)[10])[1]);
t16=(C_word)C_a_i_list(&a,3,lf[157],t14,t15);
t17=(C_word)C_a_i_list(&a,3,lf[145],t6,t16);
t18=(C_word)C_a_i_list(&a,2,lf[158],t17);
...
t4=(C_word)C_a_i_list(&a,3,lf[145],C_SCHEME_END_OF_LIST,((C_word*)t0)[7]);
t5=(C_word)C_a_i_list(&a,2,lf[146],t4);
t6=(C_word)C_a_i_list(&a,1,lf[147]);
t7=(C_word)C_a_i_list(&a,3,lf[148],((C_word*)t0)[6],lf[147]);
t8=(C_word)C_a_i_list(&a,3,lf[145],t6,t7);
t9=(C_word)C_a_i_list(&a,2,lf[149],t8);
t10=(C_word)C_a_i_list(&a,3,t3,t5,t9);
t11=(C_word)C_a_i_list(&a,3,lf[150],t10,((C_word*)((C_word*)t0)[5])[1]);
t12=(C_word)C_a_i_list(&a,3,lf[145],t2,t11);
t13=(C_word)C_a_i_list(&a,3,lf[145],((C_word*)((C_word*)t0)[4])[1],t12);
t14=((C_word*)t0)[3];
...
t3=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t3))(3,t3,t1,lf[140]);}
...
t3=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t3))(3,t3,t1,lf[137]);}
...
t2=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t2))(3,t2,t1,lf[134]);}
...
t6=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t6))(3,t6,t1,lf[131]);}
...
t5=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t5))(3,t5,t1,lf[128]);}
...
t6=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t6))(3,t6,t1,lf[125]);}
...
t6=*((C_word*)lf[39]+1);
((C_proc3)C_retrieve_proc(t6))(3,t6,t1,lf[122]);}
...
t8=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub241,a[2]=lf[119],tmp=(C_word)a,a+=3,tmp);
...
C_apply(5,0,t4,C_retrieve(lf[116]),t2,t3);}
...
t2=(C_word)C_a_i_bytevector(&a,1,C_fix(6));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub294,a[2]=lf[112],tmp=(C_word)a,a+=3,tmp);
...
t5=(*a=C_VECTOR_TYPE|1,a[1]=t4,tmp=(C_word)a,a+=2,tmp);
t6=C_set_block_item(t5,0,(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_1515,a[2]=t5,a[3]=lf[109],tmp=(C_word)a,a+=4,tmp));
t7=((C_word*)t5)[1];
f_1515(t7,t3,t2);}}
...
t6=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t6))(4,t6,t3,lf[108],t5);}}}
...
t2=(C_word)C_a_i_bytevector(&a,1,C_fix(6));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub284,a[2]=lf[105],tmp=(C_word)a,a+=3,tmp);
((C_proc3)C_retrieve_proc(t3))(3,t3,((C_word*)t0)[2],t2);}
...
t2=(C_word)C_a_i_bytevector(&a,1,C_fix(6));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub276,a[2]=lf[102],tmp=(C_word)a,a+=3,tmp);
((C_proc3)C_retrieve_proc(t3))(3,t3,((C_word*)t0)[2],t2);}
...
t2=(C_word)C_a_i_bytevector(&a,1,C_fix(6));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub280,a[2]=lf[99],tmp=(C_word)a,a+=3,tmp);
((C_proc3)C_retrieve_proc(t3))(3,t3,((C_word*)t0)[2],t2);}
...
t7=t5;
f_1435(t7,(C_truep(t6)?t6:(C_word)C_eqp(t3,lf[96])));}}}
...
C_word *a;
if(C_truep(t1)){
t2=C_mutate((C_word*)lf[89]+1,*((C_word*)lf[69]+1));
...
t3=(C_truep(t2)?t2:(C_word)C_eqp(((C_word*)t0)[3],lf[94]));
if(C_truep(t3)){
t4=C_mutate((C_word*)lf[89]+1,*((C_word*)lf[67]+1));
...
t5=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t5))(4,t5,((C_word*)t0)[4],lf[95],t4);}}}
...
t2=(C_word)C_a_i_bytevector(&a,1,C_fix(6));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub256,a[2]=lf[92],tmp=(C_word)a,a+=3,tmp);
((C_proc3)C_retrieve_proc(t3))(3,t3,((C_word*)t0)[2],t2);}
...
C_word *a;
t2=((C_word*)t0)[2];
((C_proc2)(void*)(*((C_word*)t2+1)))(2,t2,(C_truep(t1)?C_fix(1000):lf[91]));}
...
C_word t11;
C_word *a=C_alloc(12);
t4=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_1244,a[2]=t2,a[3]=lf[85],tmp=(C_word)a,a+=4,tmp);
t5=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_1356,a[2]=t4,a[3]=lf[86],tmp=(C_word)a,a+=4,tmp);
t6=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_1361,a[2]=t5,a[3]=lf[87],tmp=(C_word)a,a+=4,tmp);
...
t6=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_1246,a[2]=t4,a[3]=lf[82],tmp=(C_word)a,a+=4,tmp);
t7=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_1274,a[2]=t5,a[3]=lf[83],tmp=(C_word)a,a+=4,tmp);
t8=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_1304,a[2]=t1,tmp=(C_word)a,a+=3,tmp);
if(C_truep((C_word)C_i_pairp(((C_word*)t0)[2]))){
t9=C_SCHEME_UNDEFINED;
t10=(*a=C_VECTOR_TYPE|1,a[1]=t9,tmp=(C_word)a,a+=2,tmp);
t11=C_set_block_item(t10,0,(*a=C_CLOSURE_TYPE|6,a[1]=(C_word)f_1315,a[2]=t6,a[3]=t7,a[4]=t10,a[5]=((C_word*)t0)[2],a[6]=lf[84],tmp=(C_word)a,a+=7,tmp));
t12=((C_word*)t10)[1];
...
t4=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub289,a[2]=lf[79],tmp=(C_word)a,a+=3,tmp);
...
t5=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub269,a[2]=lf[76],tmp=(C_word)a,a+=3,tmp);
...
t2=(C_word)C_a_i_bytevector(&a,1,C_fix(6));
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)stub261,a[2]=lf[72],tmp=(C_word)a,a+=3,tmp);
...
t3=*((C_word*)lf[39]+1);
((C_proc4)C_retrieve_proc(t3))(4,t3,t1,lf[58],t2);}
else{
